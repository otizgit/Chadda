...
export default function UserSearchModal() {
  ...
  return (
    <div className="py-4 pb-6 px-3 relative z-35 w-[90%] sm:w-95 bg-light-grey rounded-[11px]">
      <div className="custom-flex mb-3">
        <h3 className="font-medium text-[1.1rem] tracking-tight">New conversation</h3>
